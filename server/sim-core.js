...
function publishState() {
    ...
    // TF・odom・sim_pose は必ず同じスタンプにする（ブラウザは sim_pose のスタンプで scan を出す）
...
async function start(rcl) {
    ...
    console.log(`[SIM] server-side simulation started (${RATE_HZ} Hz: /tf, /onestage/odom, /onestage/sim_pose)`);
}
